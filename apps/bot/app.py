...
from .handlers import estimates, files, positions
...
def build_app():
    ...
    # Свободный текст — строки позиций текущей сметы.
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, positions.add_line))
